...
bloc_m3_matrix_usage() { printf 'Usage: bash deploy/ec2/run-m3-same-az.sh --admin-cidr CIDR [--node-counts 4,7,10] [--batch-sizes 8,32,128,512] [--repetition-blocks N] [--seed N] [--validate-only]\n'; }
